...
public class NumberPicker extends LinearLayout {
     ...
     */
    private FloorPickerUIOptions uiOptions = new FloorPickerUIOptions();
    /**
     * The max width of this widget.
     */
...
//                attrs, R.styleable.NumberPicker, defStyle, 0);
        ...
        paint.setColor(Color.WHITE); //XXX MB
        ...
        //setBackgroundColor(uiOptions.selectedBackgroundColor);
...
//                //mVirtualButtonPressedDrawable.setColorFilter(Color.WHITE, Mode.SRC_ATOP);
...
//        }
        ...
        mInputText.setTextColor(uiOptions.selectedTextColor);

        // pBg .setColor(Color.WHITE);
        pBg.setColor(uiOptions.backgroundColor);
        canvas.drawRect(0, 0, getRight(), mTopSelectionDividerTop, pBg);
        canvas.drawRect(0, mBottomSelectionDividerBottom, getRight(), getBottom(), pBg);
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            // with the new one.
            if ((int) (selectorIndices.length / 2) == i) {


                //mVirtualButtonPressedDrawable.setColorFilter(Color.WHITE, Mode.SRC_ATOP);

                //mSelectorWheelPaint.setColor(Color.WHITE); // middle text
                mSelectorWheelPaint.setColor(uiOptions.selectedTextColor);
                ...
                //mSelectorWheelPaint.setColor(Color.BLACK); // other text
                mSelectorWheelPaint.setColor(uiOptions.textColor); // other text
        ...
        if (mSelectionDivider != null) {
            ...
            //mSelectionDivider.setColorFilter(Color.BLACK, Mode.SRC_ATOP); //XXX MB seprator
            //mSelectionDivider.setColorFilter(uiOptions.separatorsColor, Mode.SRC_ATOP); //XXX MB seprator
            //mSelectionDivider.draw(canvas);

            seperatorPaint.setColor(uiOptions.separatorsColor);
            canvas.drawRect(0, topOfTopDivider, getRight(), bottomOfTopDivider, seperatorPaint);
            ...
            //mSelectionDivider.setColorFilter(Color.BLACK, Mode.SRC_ATOP); //XXX MB seprator3
            //mSelectionDivider.setColorFilter(uiOptions.separatorsColor, Mode.SRC_ATOP); //XXX MB seprator3
            //mSelectionDivider.draw(canvas);
            canvas.drawRect(0, topOfBottomDivider, getRight(), bottomOfBottomDivider, seperatorPaint);
    ...
    public void setUIOptions(FloorPickerUIOptions uioptions) {
        if (uioptions != null) {
