    ...
    public:
        ...
        */
        ...
        /*! The user buffer will be used firstly. When it is full, memory pool allocates new chunk with chunk size.
            ...
            \param baseAllocator The allocator for allocating memory chunks.
        */
        MemoryPoolAllocator(char *buffer, size_t size, size_t chunkSize = kDefaultChunkCapacity,
                            BaseAllocator *baseAllocator = 0) :
        ...
        void *Realloc(void *originalPtr, size_t originalSize, size_t newSize) {
            ...
            if (originalPtr == (char *) (chunkHead_ + 1) + chunkHead_->size - originalSize) {
                ...
                if (chunkHead_->size + increment <= chunkHead_->capacity) {
                    ...
                    RAPIDJSON_ASSERT(((uintptr_t) originalPtr & 3) ==
                                     0);    // returned buffer is aligned to 4
                    return originalPtr;
                }
            }
    ...
    private:
        ...
        */
        void AddChunk(size_t capacity) {
            ChunkHeader *chunk = (ChunkHeader *) baseAllocator_->Malloc(
