...
namespace spatial {
    ...
    public:
        ...
        equal_iterator<Container> &operator++() { return increment_equal(*this); }
        ...
        //! use this form in \c for loops.
        equal_iterator<Container> &operator--() { return decrement_equal(*this); }
    ...
    public:
        ...
        //! Increments the iterator and returns the incremented value. Prefer to
        //! use this form in \c for loops.
        equal_iterator<const Container> &operator++() { return increment_equal(*this); }
        ...
        //! Decrements the iterator and returns the decremented value. Prefer to
        //! use this form in \c for loops.
        equal_iterator<const Container> &operator--() { return decrement_equal(*this); }
