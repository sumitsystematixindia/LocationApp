...
namespace spatial {
    ...
    namespace details {
        ...
        }; // sink for not using built-in compare
        ...
        struct with_builtin_difference
            ...
            }; // sink type, never used normally

            template<typename Key>
            struct builtin_difference<bracket_less<Key> > {
                typedef bracket_minus<Key, void> type;

                type operator()(const bracket_less<Key> &) const { return type(); }
            };
            ...
            struct builtin_difference<paren_less<Key> > {
                ...
                type operator()(const paren_less<Key> &) const { return type(); }
            };
            ...
            struct builtin_difference<iterator_less<Key> > {
                ...
                type operator()(const iterator_less<Key> &) const { return type(); }
            };
