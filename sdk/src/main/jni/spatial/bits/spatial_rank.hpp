...
namespace spatial {
    namespace details {
        ...
        struct Static_rank {
            ...
            //! \c Value.
            dimension_type operator()() const { return Value; }
        };
        ...
        struct Dynamic_rank {
            ...
            dimension_type operator()() const { return _rank; }
        ...
        incr_dim(const Rank &rank, dimension_type node_dim) { return (node_dim + 1) % rank(); }
