...
namespace spatial {
    ...
    public:
        ...
        mapping_iterator<Ct> &operator++() { return increment_mapping(*this); }
        ...
        //! use this form in \c for loops.
        mapping_iterator<Ct> &operator--() { return decrement_mapping(*this); }
    ...
    public:
        ...
        //! Increments the iterator and returns the incremented value. Prefer to
        //! use this form in \c for loops.
        mapping_iterator<const Ct> &operator++() { return increment_mapping(*this); }
        ...
        //! Decrements the iterator and returns the decremented value. Prefer to
        //! use this form in \c for loops.
        mapping_iterator<const Ct> &operator--() { return decrement_mapping(*this); }
    ...
    mapping_dimension(const mapping_iterator<Container> &it) { return it.mapping_dimension(); }
