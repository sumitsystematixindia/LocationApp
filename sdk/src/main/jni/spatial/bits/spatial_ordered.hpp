...
namespace spatial {
    ...
    public:
        ...
        ordered_iterator<Ct> &operator++() { return increment_ordered(*this); }
        ...
        //! use this form in \c for loops.
        ordered_iterator<Ct> &operator--() { return decrement_ordered(*this); }
    ...
    public:
        ...
        //! Increments the iterator and returns the incremented value. Prefer to
        //! use this form in \c for loops.
        ordered_iterator<const Ct> &operator++() { return increment_ordered(*this); }
        ...
        //! Decrements the iterator and returns the decremented value. Prefer to
        //! use this form in \c for loops.
        ordered_iterator<const Ct> &operator--() { return decrement_ordered(*this); }
    ...
    template<typename Container>
    inline ordered_iterator<const Container>
    ordered_cend(const Container &container) { return ordered_end(container); }
    ///@}
    ...
    template<typename Container>
    inline ordered_iterator<const Container>
    ordered_cbegin(const Container &container) { return ordered_begin(container); }
    ///@}
