...
namespace spatial {
    namespace details {
        ...
        public:
             ...
             */
            bool operator==(const Const_node_iterator<Mode> &x) const { return node == x.node; }
             ...
             */
            operator Node_iterator<Mode>() const { return Node_iterator<Mode>(node); }

            operator Const_node_iterator<Mode>() const { return Const_node_iterator<Mode>(node); }
            ///@}
             ...
             */
            dimension_type dimension() const { return static_cast<const Rank &>(*this)(); }
