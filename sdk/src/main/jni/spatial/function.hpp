...
namespace spatial {
    ...
    struct bracket_minus {
        ...
        Unit
        operator()(dimension_type n, const Tp &x, const Tp &y) const { return x[n] - y[n]; }
    };
    ...
    struct iterator_minus {
        ...
        operator()(dimension_type n, const Tp &x, const Tp &y) const {
            ...
            {
                using namespace ::std; advance(ix, n);
                advance(iy, n);
            }
            return *ix - *iy;
        }
            ...
            : private Accessor // empty member optimization
    {
        ...
        const Accessor &accessor() const { return *static_cast<const Accessor *>(this); }
    };
    ...
    struct iterator_less {
        ...
        bool operator()
            ...
            typename Tp::const_iterator iy = y.begin();
            {
                using namespace ::std; advance(ix, a);
                advance(iy, b);
            }
            return (*ix < *iy);
        }
